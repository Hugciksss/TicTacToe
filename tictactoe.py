...
btn1=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn1))
btn2=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn2))
btn3=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn3))
btn4=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn4))
btn5=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn5))
btn6=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn6))
btn7=Button(mansLogs,text=' ',width=6,height=3,bd=10,font=('Black'),bg= 'red', command=lambda:btnClick(btn7))
